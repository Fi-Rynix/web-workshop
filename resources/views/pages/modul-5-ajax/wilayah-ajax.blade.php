...
@section('title', 'Modul 5 - Wilayah Ajax')

@push('style-page')
<link rel="stylesheet" href="{{ asset('css/pages/modul-5-ajax/wilayah-ajax.css') }}">
@endpush
...
@section('extra-js')
<script src="{{ asset('js/pages/modul-5-ajax/wilayah-ajax.js') }}"></script>
@endsection
