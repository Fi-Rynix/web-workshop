...
@section('title', 'Riwayat Pesanan Tamu')
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">
                    <i class="mdi mdi-history me-2"></i>Riwayat Pesanan Guest
                </h4>
                <p class="card-description">
                    Daftar semua pesanan yang dibuat oleh pengguna Guest.
                    <strong>Mode Tamu — Pesanan Anda tidak terikat akun.</strong>
                </p>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $pesanan->nama }}</td>
                                <td><code class="text-muted">{{ $pesanan->user->nama ?? '-' }}</code></td>
                                ...
                                <td>
                                    <a href="{{ route('pesanan.guest.show', $pesanan->idpesanan) }}" class="btn btn-sm btn-info">
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-4">
                                    ...
                                    <p class="mt-2 text-muted">Belum ada pesanan tamu</p>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div class="text-muted small">
                        Menampilkan {{ $pesanans->firstItem() }} - {{ $pesanans->lastItem() }} dari {{ $pesanans->total() }} pesanan
                    </div>
                    <div>
